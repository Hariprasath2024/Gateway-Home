    ...
    <div className={`${classes.container} ${isScrolled && classes.scrolled}`}>
      <div className={classes.wrapper}>
        ...
        <ul className={classes.center}>
          ...
          <li className={classes.listItem} onClick={()=>scrollToSection("popularProperty")}>
            Feature
          </li>
          <li className={classes.listItem}  onClick={()=>scrollToSection("about")}>
            About
          </li>
          <li className={classes.listItem}  onClick={()=>scrollToSection("contact")}>
            Contacts
          </li>
        </ul>
